...
login =  function(){
	...
	if(constantes.face=="si"){
		...
		$("#login").on("click", function(){
			...
			//console.log(validar_usuario($("#id_pass").val(),  $("#pass").val()).estatus)
			...
			}else if(validar_usuario($("#id_pass").val(),  $("#pass").val()).estatus=="OK" ){
				
				data={"menu":[],"token":"123", "privilegios":[]}
				
				
							data.menu=validar_usuario($("#id_pass").val(),  $("#pass").val()).sistemas
							data.privilegios=validar_usuario($("#id_pass").val(),  $("#pass").val()).privilegios
							//data.menu.push(validar_usuario($("#id_pass").val(),  $("#pass").val()).sistemas)
							...
							localStorage.setItem("privilegios_"+cliente_bs, JSON.stringify(data.privilegios))
			...
			}else if(validar_usuario($("#id_pass").val(),  $("#pass").val()).estatus=="NO OK" ){
				$("#msj").html('<div class="alert alert-danger" role="alert">Datos Invalidos</div>')
			}
			
			
			/*else if ($("#id_pass").val()!="x" && $("#pass").val()!="x"){
				$.ajax({
						...
						success: function(data){
							//
							data.menu=[]
							data.menu.push({'menu': '<li class="vinculo" id="link_kanban" data-vinculo="sistema_prefacturacion/kanban/kanban" id="kanaban" title="Actividades"><a ><i class="fab fa-trello" aria-hidden="true"></i></a></li><li class="vinculo" id="link_clientes" data-vinculo="sistema_prefacturacion/kanban/clientes" id="kanaban" title="Clientes"><a ><i class="far fa-building" aria-hidden="true"></i></a></li>',
								'sistema': "Facturación",
								'wsUrl': "bsync_pre/"},
								{
								'sistema': 'Re-facturación',
								'menu': '<li class="vinculo" id="link_kanban" data-vinculo="sistema_resagadas/kanban/kanban" id="kanaban" title="Actividades"><a><i class="fas fa-file-invoice-dollar" aria-hidden="true"></i></a></li>',
...
function  genera_interfaz(usuario, munu){
	...
	//alert(localStorage.getItem("menu_"+cliente_bs))
						  ...
						  if(typeof(JSON.parse(localStorage.getItem("menu_"+cliente_bs)))=="object"){
								...
								//MENU DEL USUARIO
								$("#cargar_opciones").append("<span><li class='dropdown'>"+
...
function eliminar_sesion(usuario)  {
	...
	//const constantes =  JSON.parse(localStorage.getItem("constantes"))
...
function validar_usuario(usuario, clave){
	//DECLARO LOS SISTEMAS
	facturacion={"sistema": "Facturación",
				"menu": '<li class="vinculo" id="link_kanban" data-vinculo="sistema_facturacion/kanban/kanban" id="kanaban" title="Actividades"><a ><i class="fab fa-trello" aria-hidden="true"></i></a></li><li class="vinculo" id="link_clientes" data-vinculo="sistema_facturacion/kanban/clientes" id="kanaban" title="Clientes"><a ><i class="far fa-building" aria-hidden="true"></i></a></li>',
				"wsUrl": "bsync_pre/"};
	refacturacion={"sistema": 'Re-facturación',
				"menu": '<li class="vinculo" id="link_kanban" data-vinculo="sistema_refacturacion/kanban/kanban" id="kanaban" title="Actividades"><a><i class="fas fa-file-invoice-dollar" aria-hidden="true"></i></a></li>',
				"wsUrl": 'bsync/'};
	...
	sistema_pagas ={
					'sistema':'Pagos',
					'menu':'<li class="vinculo" id="link_kanban" data-vinculo="sistema_pagos/kanban/kanban" id="kanaban" title="Actividades"><a><i class="fab fa-trello" aria-hidden="true"></i></a></li><li class="vinculo" id="link_lista" data-vinculo="sistema_pagos/kanban/lista" id="lista" title="Conductores"><a><i class="fas fa-car" aria-hidden="true"></i></a></li>',
					'wsUrl': "bsync/"
	...
	if(usuario=="renny.rada" && clave=="rrada"){
		...
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="carlos.martinez" && clave=="cmartinez"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="lucas.almeida" && clave=="lalmeida"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="gabriela.marcano" && clave=="gmarcano"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="luis.jara" && clave=="ljara"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="franco.aranguiz" && clave=="faranguiz"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="luis.parra" && clave=="lparra"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="maria.roja" && clave=="mroja"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="rodian.guzman" && clave=="rguzman"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
	}else if(usuario=="darko.jacobs" && clave=="djacobs"){
		return {estatus:"OK", sistemas:[refacturacion], privilegios:[{css:"priv_generar_factura", permiso:"NO"}]};
...
function revisar_privilegios(){
	console.log(localStorage.getItem("privilegios_"+cliente_bs))
	if(localStorage.getItem("privilegios_"+cliente_bs)){
		privilegios=JSON.parse(	localStorage.getItem("privilegios_"+cliente_bs))
		for(i in privilegios){
			if(privilegios[i].permiso=="NO"){
				console.log("ELIMINAR: "+privilegios[i].css)
				$("."+privilegios[i].css).hide();
			}
